            ...
            <div class="content-bar">
                ...
                <?php if (have_posts()) : while (have_posts()) : the_post(); ?>  
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            <h1 class="post_title single"><span><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php printf(esc_attr__('Permalink to %s', 'business-pro'), the_title_attribute('echo=0')); ?>"><?php the_title(); ?></a><span></h1>
                                        <div class="post_content">
                                            <?php the_content(); ?>
                                            <div class="clear"></div>

                                            <?php wp_link_pages(array('before' => '<div class="page-link"><span>' . __('Pages:', 'business-pro') . '</span>', 'after' => '</div>')); ?>
                                            <?php if (has_tag()) { ?>
                                                <div class="tag">
                                ...
                                <nav id="nav-single"> <span class="nav-previous">
                                        <?php previous_post_link('%link', __('<span class="meta-nav">&larr;</span> Previous Post ', 'business-pro')); ?>
                                    </span> <span class="nav-next">
                                        <?php next_post_link('%link', __('Next Post <span class="meta-nav">&rarr;</span>', 'business-pro')); ?>
                                    </span> </nav>
                                <!--Start Comment box-->
